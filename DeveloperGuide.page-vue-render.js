...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TeleTutors App")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("tutor")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add a new Task")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor requests to add a new task.")])]),_v(" "),_c('li',[_c('p',[_v("Teletutors App prompts for the task details.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor provides the required task details.")])]),_v(" "),_c('li',[_c('p',[_v("Teletutors App confirms the task has been successfully added.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("3a. Tutor enters an invalid deadline\n"),_c('ul',[_c('li',[_c('p',[_v("3a1. Teletutors App displays an error message: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Invalid date format. Please use 'YYYY-MM-DD'.")])])]),_v(" "),_c('li',[_c('p',[_v("3a2. Tutor re-enters the correct date.")]),_v(" "),_c('p',[_v("Use case resumes from Step 4.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Mark student Attendance")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor requests to mark attendance for a student in a selected tutorial session.")])]),_v(" "),_c('li',[_c('p',[_v("Teletutors App displays the list of students for the session.")])]),_v(" "),_c('li',[_c('p',[_v("Tutor selects the student and specifies whether they are present or absent.")])]),_v(" "),_c('li',[_c('p',[_v("Teletutors App updates the attendance record and confirms the action.")]),_v(" "),_c('p',[_v("Use Case Ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("3a. Student is not found in the session list\n"),_c('ul',[_c('li',[_c('p',[_v("3a1. Teletutors App displays an default placeholder message: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("No students found.")])]),_v(" "),_c('p',[_v("Use case resumes from Step 2")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Delete student details")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor requests to delete a student's details.")])]),_v(" "),_c('li',[_c('p',[_v("Teletutors App prompts for confirmation")])]),_v(" "),_c('li',[_c('p',[_v("Tutor confirms the deletion.")])]),_v(" "),_c('li',[_c('p',[_v("Teletutors App deletes the student and associated records.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The student does not exist in the system\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. Teletutors App displays an error message: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Student not found. Please check the name and try again")])]),_v(" "),_c('p',[_v("Use case resumes from Step 1.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Codebase should be modular and easy to update, so that future developers can easily add new features or fix bugs.")]),_v(" "),_c('li',[_v("App should have the ability to gracefully handle a data file that is corrupted without crashing, and inform the user of the issue.")]),_v(" "),_c('li',[_v("System should gracefully recover from minor errors (e.g., incorrect or incomplete input) by either prompting the user to correct the issue, or using default values where applicable.")]),_v(" "),_c('li',[_v("System should have well-written and accessible user and developer documentation to support both end-users and future developers in using and maintaining the application.")]),_v(" "),_c('li',[_v("System should have a comprehensive suite of automated tests to ensure that new changes do not break existing functionality.")]),_v(" "),_c('li',[_v("System should implement a data retention policy, ensuring that data and records older than a certain period are archived or deleted to optimize performance and comply with legal requirements.")]),_v(" "),_c('li',[_v("System should have easy-to-use backup and restore functionality, enabling users to create backups of their data, and restore their data in the event of data loss or corruption.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Wed, 2 Oct 2024, 22:01:08 GMT+8]")])])])}
}];
